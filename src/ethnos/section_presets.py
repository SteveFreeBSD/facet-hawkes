...
HISTORY_PRESET = SectionPreset(
    name="history",
    page_ranges=(
        SectionRange(1, 8, "front_matter", "admin"),
        SectionRange(9, 11, "book_intro", "core"),
        SectionRange(12, 14, "blank_or_artifact", "artifact"),
        SectionRange(15, 38, "chapter_content", "core"),
        SectionRange(39, 41, "chapter_references", "support"),
        SectionRange(42, 66, "chapter_content", "core"),
        SectionRange(67, 69, "chapter_references", "support"),
        SectionRange(70, 92, "chapter_content", "core"),
        SectionRange(93, 95, "chapter_references", "support"),
        SectionRange(96, 119, "chapter_content", "core"),
        SectionRange(120, 122, "chapter_references", "support"),
        SectionRange(123, 150, "chapter_content", "core"),
        SectionRange(151, 153, "chapter_references", "support"),
        SectionRange(154, 173, "chapter_content", "core"),
        SectionRange(174, 176, "chapter_references", "support"),
        SectionRange(177, 202, "chapter_content", "core"),
        SectionRange(203, 205, "chapter_references", "support"),
        SectionRange(206, 234, "chapter_content", "core"),
        SectionRange(235, 238, "chapter_references", "support"),
        SectionRange(239, 266, "chapter_content", "core"),
        SectionRange(267, 270, "chapter_references", "support"),
        SectionRange(271, 298, "chapter_content", "core"),
        SectionRange(299, 301, "chapter_references", "support"),
        SectionRange(302, 324, "chapter_content", "core"),
        SectionRange(325, 327, "chapter_references", "support"),
        SectionRange(328, 353, "chapter_content", "core"),
        SectionRange(354, 356, "chapter_references", "support"),
        SectionRange(357, 385, "chapter_content", "core"),
        SectionRange(386, 389, "chapter_references", "support"),
        SectionRange(390, 420, "chapter_content", "core"),
        SectionRange(421, 424, "chapter_references", "support"),
        SectionRange(425, 451, "chapter_content", "core"),
        SectionRange(452, 454, "chapter_references", "support"),
        SectionRange(455, 460, "contributor_bios", "admin"),
        SectionRange(461, 464, "licensing", "admin"),
    ),
    chunk_ranges=(
        SectionRange(1, 1, "front_matter", "admin"),
        SectionRange(2, 2, "book_intro", "core"),
        SectionRange(3, 9, "chapter_content", "core"),
        SectionRange(10, 10, "chapter_references", "support"),
        SectionRange(11, 27, "chapter_content", "core"),
        SectionRange(28, 28, "chapter_references", "support"),
        SectionRange(29, 66, "chapter_content", "core"),
        SectionRange(67, 76, "chapter_content", "core"),
        SectionRange(77, 77, "chapter_references", "support"),
        SectionRange(78, 88, "chapter_content", "core"),
        SectionRange(89, 89, "chapter_references", "support"),
        SectionRange(90, 99, "chapter_content", "core"),
        SectionRange(100, 100, "chapter_references", "support"),
        SectionRange(101, 108, "chapter_content", "core"),
        SectionRange(109, 109, "chapter_references", "support"),
        SectionRange(110, 129, "chapter_content", "core"),
        SectionRange(130, 131, "chapter_references", "support"),
        SectionRange(132, 142, "chapter_content", "core"),
        SectionRange(143, 143, "chapter_references", "support"),
        SectionRange(144, 152, "chapter_content", "core"),
        SectionRange(153, 154, "chapter_references", "support"),
        SectionRange(155, 156, "contributor_bios", "admin"),
        SectionRange(157, 157, "licensing", "admin"),
    ),
)
