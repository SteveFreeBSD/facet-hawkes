...
`1d048672186dde7b0ab3b20c8d139c92674436e9`.
...
is what you want**: `facet-hawkes`'s is 50 commits behind this page, and
`facet-runtime`'s predates symbols this checkout imports.
...
git -C facet-runtime checkout --detach 1d048672186dde7b0ab3b20c8d139c92674436e9
cd facet-hawkes
```
