...
```text
dist/ethnos-hawkes-0.41.3-unsigned.xpi
SHA-256 3cdccd6d26e93f1e30259c5fd002b57f40f56199cb9f65061331c03c6e657687
```

0.39.0 through 0.41.2 were development builds and must not be uploaded. The
...
0.41.3 changes no permission, host, or data-collection declaration. Gates on
...
$ unzip -q dist/ethnos-hawkes-0.41.3-unsigned.xpi -d "$release_lint_dir"
...
Only after the signed XPI passes this physical-browser acceptance is 0.41.3
