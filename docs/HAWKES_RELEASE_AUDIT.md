...
| Required Facet runtime | `03ef568f4b0a89086e0ac87fa6d6f28861547ef4` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `03ef568` |
...
`03ef568f4b0a89086e0ac87fa6d6f28861547ef4`. The old Ethnos repository is not a
