...
| Required Facet runtime | `75a981f4b0d1933b41c6441ce40cca391213c004` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `75a981f` |
...
`75a981f4b0d1933b41c6441ce40cca391213c004`. The old Ethnos repository is not a
