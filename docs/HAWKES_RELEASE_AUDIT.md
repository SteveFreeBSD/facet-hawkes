...
| Required Facet runtime | `00a762cadaa4d03756d7513557ad2ee57cf83591` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `00a762c` |
...
`00a762cadaa4d03756d7513557ad2ee57cf83591`. The old Ethnos repository is not a
