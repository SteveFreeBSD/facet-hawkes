...
| Required Facet runtime | `f7a0ae15a0f7fdff5c2b7501d7bee8e42b4b92f1` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `f7a0ae1` |
...
`f7a0ae15a0f7fdff5c2b7501d7bee8e42b4b92f1`. The old Ethnos repository is not a
