...
| Required Facet runtime | `9f56fd6283c2a42a1e8a6178ba784c66fa53a6f7` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `9f56fd6` |
...
`9f56fd6283c2a42a1e8a6178ba784c66fa53a6f7`. The old Ethnos repository is not a
