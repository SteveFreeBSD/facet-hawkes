...
| Required Facet runtime | `7343ad2c20979014059d89b1a03feb6ba5ee5781` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `7343ad2` |
...
`7343ad2c20979014059d89b1a03feb6ba5ee5781`. The old Ethnos repository is not a
