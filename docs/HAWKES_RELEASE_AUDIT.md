...
| Required Facet runtime | `8bacef6829c6ac84e2c35f121a05a7ec8932dcd3` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `8bacef6` |
...
`8bacef6829c6ac84e2c35f121a05a7ec8932dcd3`. The old Ethnos repository is not a
