...
| Required Facet runtime | `89052e0765747aa0ee3db5f71d6aa3a7e8ef88cd` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `89052e0` |
...
`89052e0765747aa0ee3db5f71d6aa3a7e8ef88cd`. The old Ethnos repository is not a
