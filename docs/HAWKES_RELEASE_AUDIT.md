...
| Required Facet runtime | `fab053febe6805a8898e1b2d7c1f27792bcb3433` |
...
| Companion topology | sibling `facet-hawkes` + `facet-runtime`; CI pins runtime `fab053f` |
...
`fab053febe6805a8898e1b2d7c1f27792bcb3433`. The old Ethnos repository is not a
